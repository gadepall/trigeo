...
\begin{figure}[!ht]
\centering
\resizebox{0.6\columnwidth}{!}{\input{./figs/trig/tri_right_angle.tex}}
...
\begin{figure}[!ht]
	\begin{center}
		\resizebox{0.6\columnwidth}{!}{\input{./figs/trig/tri_baudh.tex}}
	\end{center}
...
\begin{figure}[!ht]
	\begin{center}
			\resizebox{0.6\columnwidth}{!}{\input{./figs/triangle/tri_sss.tex}}
	\end{center}
...
\begin{figure}[!ht]
	\begin{center}
		...
		%\vspace*{-10cm}
		\resizebox{0.6\columnwidth}{!}{\input{./figs/triangle/tri_sin_inc.tex}}
	\end{center}
	\caption{}
...
\begin{figure}[!ht]
	\begin{center}
		...
		%\vspace*{-10cm}
		\resizebox{0.6\columnwidth}{!}{\input{./figs/triangle/tri_cosine_formula.tex}}
	\end{center}
...
\begin{figure}[!ht]
	\begin{center}
		...
		\resizebox{0.6\columnwidth}{!}{\input{./figs/trig/tri-icentre.tex}}
	\end{center}
...
\frac{l_2}{\sin \theta}
  ...
  \end{align}
		\begin{figure}[!ht]
	\begin{center}
		\resizebox{0.6\columnwidth}{!}{\input{./figs/trig/tri-iradius.tex}}
	\end{center}
...
\begin{figure}[!ht]
	\begin{center}
		\resizebox{0.6\columnwidth}{!}{\input{./figs/trig/tri_icircle.tex}}
	\end{center}
...
\begin{figure}[!ht]
	\begin{center}
		\resizebox{0.6\columnwidth}{!}{\input{./figs/trig/tri_isosc.tex}}
	\end{center}
...
\begin{figure}[!ht]
	\begin{center}
		...
		\resizebox{0.6\columnwidth}{!}{\input{./figs/coord/tri-perp-bis.tex}}
	\end{center}
...
\begin{figure}[!ht]
	\begin{center}
		...
		\resizebox{0.6\columnwidth}{!}{\input{./figs/coord/tri_ccentre.tex}}
	\end{center}
...
\begin{figure}[!ht]
	\begin{center}
		\resizebox{0.6\columnwidth}{!}{\input{./figs/coord/tri_ccircle.tex}}
	\end{center}
...
\label{them:tang_icept_ang}
	\begin{figure}[!ht]
		\begin{center}
			...
			%\vspace*{-10cm}
			\resizebox{0.6\columnwidth}{!}{\input{./figs/coord/circ_tang_icept.tex}}
		\end{center}
		\caption{$\theta= \alpha$.}
...
\begin{figure}[!ht]
	\begin{center}
		\resizebox{0.6\columnwidth}{!}{\input{./figs/coord/tri_med_isect.tex}}

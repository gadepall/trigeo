...
\begin{figure}[!ht]
\centering
\resizebox{0.6\columnwidth}{!}{\input{figs/trig_id/tri_right_angle.tex}}
...
\begin{figure}[!ht]
	\begin{center}
		\resizebox{0.6\columnwidth}{!}{\input{figs/trig_id/tri_baudh.tex}}
	\end{center}
...
\begin{figure}[H]
	\centering
		\resizebox{0.6\columnwidth}{!}{\input{figs/trig_id/tri_isoc-alt.tex}}
	\caption{$B = C$}
...
\begin{figure}[!ht]
	\begin{center}
			\resizebox{0.6\columnwidth}{!}{\input{figs/trig_id/tri_sss.tex}}
	\end{center}
...
\begin{figure}[H]
	\centering
		\resizebox{0.6\columnwidth}{!}{\input{figs/trig_id/tri_isoc.tex}}
	\caption{}
	\label{fig:tri_isoc}
\end{figure}
...
\begin{figure}[!ht]
	\begin{center}
		...
		%\vspace*{-10cm}
		\resizebox{0.6\columnwidth}{!}{\input{figs/trig_id/tri_cosine_formula.tex}}
	\end{center}
...
\begin{figure}[!ht]
	\begin{center}
		...
		%\vspace*{-10cm}
		\resizebox{0.6\columnwidth}{!}{\input{figs/trig_id/tri_sin_inc.tex}}
	\end{center}
	\caption{}
...
\begin{figure}[!ht]
	\begin{center}
		...
		\resizebox{0.6\columnwidth}{!}{\input{figs/trig_id/tri-icentre.tex}}
	\end{center}
...
\frac{l_2}{\sin \theta}
  ...
  \end{align}
		\begin{figure}[!ht]
	\begin{center}
		\resizebox{0.6\columnwidth}{!}{\input{figs/trig_id/tri-iradius.tex}}
	\end{center}
...
\begin{figure}[!ht]
	\begin{center}
		\resizebox{0.6\columnwidth}{!}{\input{figs/trig_id/tri_icircle.tex}}
	\end{center}
...
\begin{figure}[H]
	\centering
		\resizebox{0.6\columnwidth}{!}{\input{figs/trig_id/tri_isoc_ang_bsect.tex}}
	\caption{}
...
\begin{figure}[!ht]
	\begin{center}
		\resizebox{0.6\columnwidth}{!}{\input{figs/trig_id/tri_isosc.tex}}
	\end{center}
...
\begin{figure}[!ht]
	\begin{center}
		...
		\resizebox{0.6\columnwidth}{!}{\input{figs/trig_id/tri-perp-bis.tex}}
	\end{center}
...
\begin{figure}[!ht]
	\begin{center}
		...
		\resizebox{0.6\columnwidth}{!}{\input{figs/trig_id/tri_ccentre.tex}}
	\end{center}
...
\begin{figure}[!ht]
	\begin{center}
		\resizebox{0.6\columnwidth}{!}{\input{figs/trig_id/tri_ccircle.tex}}
	\end{center}
...
%
	\begin{figure}[!ht]
		\begin{center}
			...
			%\vspace*{-10cm}
			\resizebox{0.6\columnwidth}{!}{\input{figs/trig_id/circ_tang_icept.tex}}
		\end{center}
		\caption{$\theta= \alpha$.}
...
\begin{figure}[!ht]
	\begin{center}
		\resizebox{0.6\columnwidth}{!}{\input{figs/trig_id/tri_med.tex}}
	\end{center}
	\caption{$k_1=k_2$.}
	\label{fig:tri_med}	
\end{figure}
...
\begin{figure}[!ht]
	\begin{center}
		\resizebox{0.6\columnwidth}{!}{\input{figs/trig_id/tri_med_isect.tex}}
	\end{center}
	\caption{Equal areas.}
...
\begin{figure}[H]
	\begin{center}
		\resizebox{0.6\columnwidth}{!}{\input{figs/trig_id/tri_med_meet.tex}}
	\end{center}
	\caption{$k_3=k$.}
...
\begin{figure}[H]
	\begin{center}
		\resizebox{0.6\columnwidth}{!}{\input{figs/trig_id/tri_med_sim.tex}}
	\end{center}
	\caption{k = 2}

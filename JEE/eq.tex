...
in the interval \sbrak{0,2\pi}  is \rule{1cm}{0.1pt}.\hfill{\brak{JEE Adv.2015}} 
...
\end{enumerate}
\end{multicols}
\item The number of solution of $\tan x + \sec x=2\cos x$ in \sbrak{0,2\pi}  is \rule{1cm}{0.1pt}.\hfill{\brak{2002}} 
\begin{multicols}{4}
\begin{enumerate}
\item $2$
\columnbreak
...
%
$2\sin^2 x+5\sin x-3=0$  is \rule{1cm}{0.1pt}. \hfill{\brak{2006}}
\begin{multicols}{4}
\begin{enumerate}
\item 4
\columnbreak
...
$3 \sin{\brak{x^2}}-7 \sin{x+2}=0$  \hfill\brak{1998} 
\begin{enumerate}
    \item $0$
    \item $5$
    \item $6$
...
\item Which of the following number\brak{s} is/are rational? \hfill\brak{1998} 
\begin{enumerate}
    \item $\sin{15}\degree$
    \item $\cos{15}\degree$

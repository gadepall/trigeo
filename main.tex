...
\input{geometry/hd.tex}
\subsection{Sine and Cosine Formula}
\input{geometry/sincos.tex}
\subsection{NCERT}
\input{ncert/hd.tex}
\subsection{CBSE}
\input{cbse/hd.tex}
...
\input{geometry/tri.tex}
\subsection{Medians}
\input{geometry/median.tex}
\subsection{NCERT}
\input{ncert/tri.tex}
\subsection{CBSE}
\input{cbse/tri.tex}
...
\section{Circle}
\subsection{Incircle}
\input{geometry/incircle.tex}
\subsection{Circumcircle}
\input{geometry/ccircle.tex}
\subsection{NCERT}
...
\subsection{NCERT}
 \input{ncert/complex.tex}
%\appendices
%
% \input{cbse-math/main.tex}
\end{document}
